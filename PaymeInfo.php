...
ob_start();
define("UzHelpUz","1952869945:AAFGqLbn3DzNz3TxbhIuTi_EBqnmmzUs0Hs");
$admin = "1845629162";
$botname = "PaymeUz_bot";
...
function joinchat($id){
     ...
     $ret = uzfox("getChatMember",[
         "chat_id"=>"-1001372208578",
         "user_id"=>$id,
         ]);
$stat = $ret->result->status;
$rets = uzfox("getChatMember",[
         "chat_id"=>"-1001547392642",
         "user_id"=>$id,
         ]);
...
"inline_keyboard"=>[
[["text"=>"➕ A‘zo bo‘lish","url"=>"https://t.me/UzShazam"],],
[["text"=>"➕ A‘zo bo‘lish","url"=>"https://t.me/Ruzbet"],],
     ...
     if(file_exists("uzfox/".$id.".referalid")){
           ...
           if($get=="true"){
            ...
            file_put_contents("uzfox/".$file.".pul","$user");
             uzfox("sendMessage",[
             "chat_id"=>$file,
             "text"=>"<b>Sizning do'stingiz</b>, <a href='tg://user?id=".$id."'>".$firstname."</a> <b>bizning kanallarimizdan chiqib ketgani uchun sizga ".$500." so'm jarima berildi.</b>",
             "parse_mode"=>"html",
             "reply_markup"=>$menu,
             ]);
           }
...
function phonenumber($id){
     ...
     uzfox("sendPhoto",[
    "chat_id"=>$id,
"photo"=>"https://t.me/PhotosTGuz/24",
...
<pre>[UzHelp+https://t.me/Payme_Info]\n[Yangiliklar+https://t.me/UzShazam]</pre>",
"parse_mode"=>"html",
                      "disable_web_page_preview"=>true,
                    ]);
...
"photo"=>"https://t.me/mr_aash/10",
    "caption"=>"✅ <b>PayMe tizimining rasmiy boti</b> 🤖\n\n🎈 $username do'stingizdan unikal havola-taklifnoma.\n\n👇 Boshlash uchun bosing:
...
"parse_mode"=>"markdown",
       ...
       uzfox("sendMessage",[
              ...
              "parse_mode"=>"html",
               "reply_markup"=>json_encode([   
   "inline_keyboard"=>[
[["text"=>"👨‍💻 Admin","url"=>"https://telegram.me/UzHelpUz"]],
]
]),
]);
}
...
"disable_web_page_preview"=>true,
"parse_mode"=>"html",
"message_text"=>"✅ <b>PayMe tizimining rasmiy boti</b> 🤖\n\n🎈 $username do'stingizdan unikal havola-taklifnoma.\n\n👇 Boshlash uchun bosing:
...
uzfox("sendMessage",[
   "chat_id"=>$chatid,
   "text"=>"Nima haqida yozmoqchisiz? 😊\n\n<b>📞 Aloqa markazi:</b> @UzHelpUz",
"parse_mode"=>"html",
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[["text"=>"🗣 Bog'lanish","url"=>"https://t.me/UzHelpUz"],],
]
]),
]);
}
...
if($text=="🎁 Promo Kod" and $ban==false){
if((joinchat($fromid)=="true") and (phonenumber($fromid)=="true") and ($ban==false)){
uzfox("sendMessage",[
   "chat_id"=>$chatid,
   "text"=>"🎁 Kim bonus omadi 3 000 000 ro'yhatdan o'tgani uchun. 

Mendan so'raydi hamma kanalim a'zolari! 
« Qayerda siz garov tikasiz? »

⚠️  Javob beraman hammaga  ⚠️
 Men garov tikaman  👉🏻 LINEBET 💰 

❗️  Nimaga endi «LINEBET» 

 👇🏻  Javob  👇🏻 

😉 Juda oson va tez ro'yhatdan o'tish 
✅ Juda katta koeffitsientlar 
💳 Ummuman muammo yo'q pul yechib, hisobni to'ldirishdan
💻 LINEBET tavsiyalar juda ko'p, Liniya va Live ga garov tikish 
📺 Hamma o'yinlardi jonli ko'rishiz mumkun
📱 Juda qulay ilovasi bor  telefon uchun 
💯 Bonus hamma yangi ro'yhatdan o'tganlar uchun 
👨‍🔧 Qo'llab quvatlash xizmati 24 soat onlayn 

🎁 Eslatib o'taman:  Ro'yhatdan o'tayotganizda albatta ssilka orqali ro'yatdan o'ting 👉🏻 https://t.me/Payme_Info va
 GOLDHOUSE promokodini kirgizing 3 000 000 birinchi depozitga ega bo'ling.
 Eslab Qoling: Ushbu ssilkaga javob bermaymiz va shunchaki bonus taklif etdik xolos! 🎁

PROMOKOD: <code>GOLDHOUSE</code>",
"parse_mode"=>"html",
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[["text"=>"🎁 Promo Kod Olish","url"=>"https://t.me/UzHelpUz"],],
]
]),
]);
}
...
uzfox("sendPhoto",[
"chat_id"=>$chatid,
"photo"=>"https://t.me/PhotosTGuz/15",
"caption"=>"<b>Bot dasturchisi:</b> <a href='tg://user?id=1845629162'>UzHelpUz</a>\n\n<b>Ish vaqti: 07:00 dan 23:00 gacha</b>\n\n<b>Diqqat! Bot pul to'lab berish yoki to'lab bermasligiga dasturchi javobgar emas!</b>",
"parse_mode"=>"html",
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[["text"=>"♻️ Bogʻlanish","url"=>"https://t.me/UzHelpUz"],],
]
]),
]);
}
